...
(2, 'Contrucción de Iglesia', 'No se pudo', 1, 0x4172636869766f2e706466, '0000-00-00 00:00:00', 'casa comunal pallaccocha', '71603456');
...
('71603456', '$2y$10$LnnA/pnNlthvhuGhFLlzfelo9Vwnnj1T6Nu6nWydvUHKxyk18rfnK', 'tesorero', 1, 'Sara', 'Pariona Alhuay', '934512111'),
('71609235', '$2y$10$LnnA/pnNlthvhuGhFLlzfelo9Vwnnj1T6Nu6nWydvUHKxyk18rfnK', 'secretario', 1, 'Ruben', 'Vargas Cabezas', '934512366'),
('71609806', '$2y$10$LnnA/pnNlthvhuGhFLlzfelo9Vwnnj1T6Nu6nWydvUHKxyk18rfnK', 'presidente', 0, 'Julio', 'Memenza Altamirano', '934512341');
...
--
ALTER TABLE `acta`
  ADD CONSTRAINT `acta_ibfk_1` FOREIGN KEY (`dni_usuario`) REFERENCES `usuario` (`dni`);
