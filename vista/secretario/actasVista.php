        ...
        <div class="barra_menu">
            ...
            <div class="opciones_menu">
                ...
                <div class="opcion">
                    ...
                    <a href="../../vista/secretario/actasVista.php">CREAR ACTA</a>

                </div>

                <div class="opcion">
                    <i class="fa-sharp fa-solid fa-file-circle-question"></i>
                    <a href="../../vista/usuariosV.php">ASISTENCIAS</a>
                </div>

                <div class="opcion">
                    <i class="fa-solid fa-list-check"></i>
                    <a href="../../vista/usuariosV.php">DEUDAS</a>
                </div>

                <div class="opcion">

                    <i class="fa-solid fa-list-check"></i>
                    <a href="../../vista/usuariosV.php">POBLADORES</a>
                </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4>ACTAS COMUNALES-PALLACCOCHA
                                    ...
                                    <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#agregarActaModal"><i class="bi bi-file-plus-fill"></i>
                                        Agregar Acta
                                    </button>
                                </h4>
                                <br>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" value="<?= $numero; ?>" class="editarActaBtn btn btn-success btn-sm">
